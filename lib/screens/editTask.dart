...
class EditTask extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<TaskCubit,TaskState>(builder: (context,state){
            ...
            child: Hero(tag: 'GFG Tag', child: SingleChildScrollView(
                child: Column(children: [
                  Stack(children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.only(top: 100,left: 190),
                      child: Text("Edit your tasks", style: GoogleFonts
                          .acme(textStyle:
                  ...
                  Column(children: [
                    ...
                    Padding(
                      ...
                      child: Row( mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        children: [
                          Container(width: 150.w,decoration: BoxDecoration(borderRadius: BorderRadius.circular(50)),
                            child: ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.orange[900] ),
                                onPressed: (){ cubit.editTask();
                              cubit.clearText();
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>  TaskScreen()));}, child: Text("Edit",style: GoogleFonts
                                    .acme(textStyle:
                                TextStyle(
                                  fontSize: 25.sp,)))),
                          ),
                        Spacer(),
                          Container( width: 150.w,decoration: BoxDecoration(borderRadius: BorderRadius.circular(50),),
                            child: ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.orange[900] ),
                              ...
                              //cubit.clearText();
                                Navigator.push(context, MaterialPageRoute(builder: (context)=>  TaskScreen()));}, child: Text("Delete",style: GoogleFonts
                                    .acme(textStyle:
                                TextStyle(
                                  fontSize: 25.sp,)))),
                          ),
      ...
      if (state is EditTaskSuccess || state is DeleteSuccess){
